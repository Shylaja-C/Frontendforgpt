...
export default function HomePage() {
  ...
  const [hov, setHov] = useState(null);
    ...
    'ta-IN': [
      ...
      { img: IMG.soil, icon: "🌿", title: "தாவர மருத்துவர்", desc: "பயிர் புகைப்படம் பதிவேற்றி நோயை கண்டறியுங்கள்.", path: "/plant", color: "#2e7d32", bg: "#f1f8e9" },
    ...
    'hi-IN': [
      ...
      { img: IMG.soil, icon: "🌿", title: "पौधा डॉक्टर", desc: "फसल की फोटो अपलोड करें और बीमारी पहचानें।", path: "/plant", color: "#2e7d32", bg: "#f1f8e9" },
    ...
    'te-IN': [
      ...
      { img: IMG.soil, icon: "🌿", title: "మొక్క వైద్యుడు", desc: "పంట ఫోటో అప్‌లోడ్ చేసి వ్యాధిని గుర్తించండి.", path: "/plant", color: "#2e7d32", bg: "#f1f8e9" },
    ...
    'kn-IN': [
      ...
      { img: IMG.soil, icon: "🌿", title: "ಸಸ್ಯ ವೈದ್ಯ", desc: "ಬೆಳೆ ಫೋಟೋ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ ರೋಗ ಪತ್ತೆ ಮಾಡಿ.", path: "/plant", color: "#2e7d32", bg: "#f1f8e9" },
    ...
    'ml-IN': [
      ...
      { img: IMG.soil, icon: "🌿", title: "സസ്യ ഡോക്ടർ", desc: "വിള ഫോട്ടോ അപ്‌ലോഡ് ചെയ്ത് രോഗം കണ്ടെത്തുക.", path: "/plant", color: "#2e7d32", bg: "#f1f8e9" },
